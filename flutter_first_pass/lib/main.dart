...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => ChatProvider())  //Tenemos un provider encargado del chat
      ],
      child: MaterialApp(
        debugShowCheckedModeBanner: false, //Quitar etiqueta modo de desarrollo
        theme: AppTheme(selectColor: 0).theme(), //Seleccion de tema dinamico mediante clase AppTheme
        title: 'Chat',
        // theme: ThemeData(
        //   colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepOrange),
        //   useMaterial3: true, //Uso de material
        // ),
        home: const ChatScreen(), //Widget Base para el chat
      ),
    );
  }
}
